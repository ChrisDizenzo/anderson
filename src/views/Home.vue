    ...
    <section class="text-gray-700 bg-gray-200 body-font">
      <div class="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center">
        ...
        <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          <h1 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-gray-900" @click="updateVariable('betterTitle')">{{home.betterTitle}}
          </h1>
          <p class="mb-8 text-gray-900 leading-relaxed" @click="updateVariable('betterDesc')"><span v-html="home.betterDesc"></span></p>
        </div>
      </div>
    </section>
      ...
      <section class="text-gray-700 body-font">
        <div class="container px-5 pt-12 pb-24 mx-auto md:mx-0">
          <div class="flex flex-col text-center w-full mb-20">
            <h1 class="sm:text-4xl text-3xl font-bold title-font mb-4 text-gray-900" @click="updateVariable('whatWeDoTitle')" >{{home.whatWeDoTitle}}</h1>
            <p class="lg:w-2/3 mx-auto text=gray-600 leading-relaxed" @click="updateVariable('whatWeDoDesc')">{{home.whatWeDoDesc}}</p>
          </div>
          <div class="flex flex-wrap -m-4">
            <div class="p-4 mx-auto md:mx-0 lg:w-1/3 md:w-1/2">
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  <h2 class="title-font font-bold text-lg text-gray-900" @click="updateVariable('whatWeDoTitle1')">{{home.whatWeDoTitle1}}</h2>
                  <p class="text-gray-600 mt-4" @click="updateVariable('whatWeDoDesc1')">{{home.whatWeDoDesc1}}</p>
            ...
            <div class="p-4 mx-auto md:mx-0 lg:w-1/3 md:w-1/2">
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  <h2 class="title-font font-bold text-lg text-gray-900" @click="updateVariable('whatWeDoTitle2')">{{home.whatWeDoTitle2}}</h2>
                  <p class="text-gray-600 mt-4" @click="updateVariable('whatWeDoDesc2')">{{home.whatWeDoDesc2}}</p>
                  <span class="inline-flex">
                    <a class="text-gray-500">
                      <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
            ...
            <div class="p-4 mx-auto md:mx-0 lg:w-1/3 md:w-1/2">
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  <h2 class="title-font font-bold text-lg text-gray-900" @click="updateVariable('whatWeDoTitle3')">{{home.whatWeDoTitle3}}</h2>
                  <p class="text-gray-600 mt-4" @click="updateVariable('whatWeDoDesc3')">{{home.whatWeDoDesc3}}</p>
                  <span class="inline-flex">
                    <a class="text-gray-500">
                      <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
    ...
    <section class="text-gray-700 body-font">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          <h1 class="sm:text-4xl text-3xl font-bold title-font mb-4 text-gray-900" @click="updateVariable('eventsTitle')">{{home.eventsTitle}}</h1>
        </div>
        <div class="flex flex-wrap -m-4">
          <div class="p-4 md:w-1/3">
            <div class="h-full w-full sm:w-auto border-2 border-gray-200 rounded-lg overflow-hidden">
              ...
              <div class="p-6">
                <p class="leading-relaxed mb-1 text-sm" @click="updateVariable('event1Time')">{{home.event1Time}}</p>

                <a onclick="window.open(this.href); return false;" href="https://uclaanderson.campusgroups.com/entrepreneur/rsvp?event_uid=a0d3dedaec0263f6e21866e1e38db58e" class="hover:underline title-font text-xl font-bold text-teal-500 mb-3">{{home.event1Title}}</a>
          ...
          <div class="p-4 md:w-1/3">
            <div class="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
              ...
              <div class="p-6">
                <p class="leading-relaxed mb-1 text-sm" @click="updateVariable('event2Time')">{{home.event2Time}}</p>

                <a onclick="window.open(this.href); return false;" href="https://uclaanderson.campusgroups.com/entrepreneur/rsvp?event_uid=79997a59d521ebdea0c8ebcd6374a1f9" class="hover:underline title-font text-xl font-bold text-teal-500 mb-3">{{home.event2Title}}</a>
          ...
          <div class="p-4 md:w-1/3">
            <div class="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
              ...
              <div class="p-6">
                <p class="leading-relaxed mb-1 text-sm" @click="updateVariable('event3Time')">{{home.event3Time}}</p>

                <a onclick="window.open(this.href); return false;" href="https://uclaanderson.campusgroups.com/entrepreneur/rsvp?event_uid=f176124975303f8e05321d5089b63de9" class="hover:underline title-font text-xl font-bold text-teal-500 mb-3">{{home.event3Title}}</a>
